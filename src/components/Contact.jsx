  ...
  return (
    ...
    >
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lb:max-w-[30ch]">
            Let’s connect to discuss your project requirements and turn ideas into something incredible!
            </p>
            ...
            <form 
            action="https://getform.io/f/bolgnrga"
            method="POST"
